package com.chatbot.openai.api.data.embedding.response;

import com.chatbot.openai.api.data.embedding.response.block.EmbeddingResponseBlockData;
import com.chatbot.openai.api.data.embedding.response.usage.EmbeddingResponseUsageData;
